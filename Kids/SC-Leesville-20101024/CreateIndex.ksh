...
<html>
<head>
<title>Family Gathering - October 24, 2010</title>

<link rel=stylesheet href="CD.css" type="text/css">

<meta name="description" content="Images of a family gathering - October 24, 2010.  Photography by and Copyright Doug Greenwald, all rights reserved." />
<meta name="keywords" content="doug, greenwald, photography, family, gathering, sc, south, carolina" />
...
<title>Family Gathering - October 24, 2010 - ${SectionTitle} - ${ImageFile}</title>
...
EOF
    ...
    then
      ...
      echo "      $ZFInfo"
      cat >> _Screen/${ImageFile}.html << EOF
      <p align=center class="Caption"><a href="${ZFURLPrefix}${ZFGal}/?photo=${ZFid}">Click Here</a> if you would like to purchase this image as a large print, poster, puzzle, or mousepad.<br>PASSWORD IS brenda20101024</p>
EOF
    fi
