...
<html>
<head>
<title>Life in Christ Lutheran Church</title>

<link rel=stylesheet href="${StylePrefix}/SelfPorts01.css" type="text/css">

<meta name="description" content="Images of the Life in Christ Lutheran Church in Peoria, AZ.  Photography by and Copyright Doug Greenwald, all rights reserved." />
<meta name="keywords" content="doug, greenwald, photography, life, in, christ, lutheran, church, peoria, az, arizona" />
...
<title>Life in Christ Lutheran Church - ${SectionTitle} - ${ImageFile}</title>
