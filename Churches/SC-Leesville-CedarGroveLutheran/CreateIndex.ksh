...
<html>
<head>
<title>Cedar Grove Evangelical Lutheran Church</title>

<link rel=stylesheet href="CD.css" type="text/css">

<meta name="description" content="Images of the Cedar Grove Evangelical Lutheran Church in Leesville, SC.  Photography by and Copyright Doug Greenwald, all rights reserved." />
<meta name="keywords" content="doug, greenwald, photography, cedar, grove, evangelical, lutheran, church, leesville, sc, south, carolina" />
...
<title>Cedar Grove Evangelical Lutheran Church - ${SectionTitle} - ${ImageFile}</title>
