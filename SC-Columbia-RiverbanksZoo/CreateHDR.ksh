...
##
##  create the header of the index-h.html file
##

cat > index-h.html <<EOF
<html>
<head>
...
for SectionFile in HDR??
do

  SectionName=`head -1 ${SectionFile}`

  echo "<li><a href=\"#${SectionFile}\">${SectionName}</a>" >> index-h.html
...
EOF
  ...
  #
  #  add entry to index-h.html
  #

  if [ "$IMAGECOUNT" = "2" ]
  then
    echo "<td width=20>&nbsp;</td>" >> index-h.html
    echo "<td align=center valign=top><a href=\"_Screen/${ImageFile}.html\"><img src=\"_Thumb/${ImageFile}\" width=\"${TWidth}\" height=\"${THeight}\"></a>" >> index-h.html
    echo "<br clear=\"all\">" >> index-h.html
    echo "<p class=\"caption\">${ImageCaption}</p>" >> index-h.html
    echo "</td>" >> index-h.html
    echo "</tr>" >> index-h.html
    echo "<tr><td width=20>&nbsp;</td><td>&nbsp;</td></tr>" >> index-h.html
    IMAGECOUNT=3
  fi
  ...
  then
    echo "<tr>" >> index-h.html
    echo "<td width=10>&nbsp;</td>" >> index-h.html
    echo "<td align=center valign=top><a href=\"_Screen/${ImageFile}.html\"><img src=\"_Thumb/${ImageFile}\" width=\"${TWidth}\" height=\"${THeight}\"></a>" >> index-h.html
    echo "<br clear=\"all\">" >> index-h.html
    echo "<p class=\"caption\">${ImageCaption}</p>" >> index-h.html
    echo "</td>" >> index-h.html
...
#cp -p index-h.html StartHere.html
