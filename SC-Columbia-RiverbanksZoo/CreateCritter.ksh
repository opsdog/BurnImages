...
##
##  create the header of the index-c.html file
##

cat > index-c.html <<EOF
<html>
<head>
...
for SectionFile in Critter??
do

  SectionName=`head -1 ${SectionFile}`

  echo "<li><a href=\"#${SectionFile}\">${SectionName}</a>" >> index-c.html
...
EOF
  ...
  #
  #  add entry to index-c.html
  #

  if [ "$IMAGECOUNT" = "2" ]
  then
    echo "<td width=20>&nbsp;</td>" >> index-c.html
    echo "<td align=center valign=top><a href=\"_Screen/${ImageFile}.html\"><img src=\"_Thumb/${ImageFile}\" width=\"${TWidth}\" height=\"${THeight}\"></a>" >> index-c.html
    echo "<br clear=\"all\">" >> index-c.html
    echo "<p class=\"caption\">${ImageCaption}</p>" >> index-c.html
    echo "</td>" >> index-c.html
    echo "</tr>" >> index-c.html
    echo "<tr><td width=20>&nbsp;</td><td>&nbsp;</td></tr>" >> index-c.html
    IMAGECOUNT=3
  fi
  ...
  then
    echo "<tr>" >> index-c.html
    echo "<td width=10>&nbsp;</td>" >> index-c.html
    echo "<td align=center valign=top><a href=\"_Screen/${ImageFile}.html\"><img src=\"_Thumb/${ImageFile}\" width=\"${TWidth}\" height=\"${THeight}\"></a>" >> index-c.html
    echo "<br clear=\"all\">" >> index-c.html
    echo "<p class=\"caption\">${ImageCaption}</p>" >> index-c.html
    echo "</td>" >> index-c.html
...
#cp -p index-c.html StartHere.html
