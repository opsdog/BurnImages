...
<html>
<head>
<title>Subway Car Show - Gilbert, SC</title>

<link rel=stylesheet href="CD.css" type="text/css">

<meta name="description" content="Images of the Subway Car Show in Gilbert, SC.  Photography by and Copyright Doug Greenwald, all rights reserved." />
<meta name="keywords" content="doug, greenwald, photography, car, auto, automobile, show, subway, gilbert, sc, south, carolina" />
...
<title>Subway Car Show - ${SectionTitle} - ${ImageFile}</title>
